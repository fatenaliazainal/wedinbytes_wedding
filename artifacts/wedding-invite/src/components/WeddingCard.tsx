      ...
      <section className="relative z-10">
        ...
        <div className="relative z-10 flex flex-col items-center gap-[50px] pt-16 pb-28 px-[60px]">
          ...
          <div className="w-full max-w-sm text-center flex flex-col">
            ...
            {/* Parents → Invitation message: 18px */}
            <p className="mt-[18px] text-sm text-foreground/70 leading-relaxed" style={{ fontFamily: bodyFontFamily }} dangerouslySetInnerHTML={{ __html: sanitizeHtml(invitationText) }} />
            {/* Invitation message → Couple names: 20px | Couple names internal: 4px */}
