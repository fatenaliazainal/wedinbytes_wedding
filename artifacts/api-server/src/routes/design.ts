...
const ALLOWED_DESIGN_FIELDS = [
  ...
  "fontHeading","fontBody","nameFontFamily","nameFontSize","badgeFontSize","greetingFontSize","eyebrowFontSize","dayFontSize","dateFontSize","hashtagFontSize","nameColor","greetingColor",
