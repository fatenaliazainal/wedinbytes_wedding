---
name: Catalog preview style
description: Visual treatment for the public wedding-card catalog previews.
---

The public catalog and homepage card showcases use direct portrait invitation previews without a phone frame or outer white border; the catalog uses a compact card with only design name, code, and order CTA, while the All-in-One marketing section intentionally keeps a larger live phone preview to explain the product.
